...
<h2 class="text-uppercase text-center">Login / Registar</h2></br>
            ...
            <div class="login-html">
                ...
                <div class="login-form">
                    ...
                    <div class="sign-up-htm">
                        ...
                        <div class="group">
                            <label for="pass" class="label">Reescrever Password</label>
                            <input id="pass" type="password" class="input" data-type="password">
                        </div>
                        <div class="group">
                            <label for="pass" class="label">Primeiro nome</label>
                            <input id="pass" type="text" class="input">
                        </div>
                        <div class="group">
                            <label for="pass" class="label">Apelido</label>
                            <input id="pass" type="text" class="input">
                        </div>
                        <div class="group">
                            <label for="pass" class="label">Telemóvel</label>
                            <input id="pass" type="number" class="input">
                        </div>
                        <div class="group">
                            <label for="pass" class="label">Morada</label>
                            <input id="pass" type="text" class="input">
                        </div>
                        <div class="group">
